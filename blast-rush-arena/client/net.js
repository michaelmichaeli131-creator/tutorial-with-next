(() => {
  ...
  class BlastNetwork extends EventTarget {
    ...
    setName(name) {
      ...
      if (this.connected) this.send({ type: 'hello', playerId: this.playerId, name: clean });
      return clean;
    }
    ...
    async connect() {
      ...
      this.connecting = new Promise((resolve) => {
        ...
        socket.addEventListener('open', () => {
          ...
          this.send({ type: 'hello', playerId: this.playerId || undefined, name: this.playerName });
    ...
    createRoom() { return this.command({ type: 'create_room' }); }
